...
from ogs_riverger.utils.array_utils import find_slice
from ogs_riverger.utils.array_utils import get_best_unique_element
...
def read_efas_data_files(
    ...
    _, slicing_indices = get_best_unique_element(
...
def _read_raw_content_of_unzipped_efas_file(
    ...
    try:
        with ExitStack() as current_stack:
            ...
            i_lat1, i_lat2 = find_slice(domain_latitudes, dataset_latitudes)
            i_lon1, i_lon2 = find_slice(domain_longitudes, dataset_longitudes)
...
def _read_efas_forecast_file(dataset: xr.Dataset):
    ...
    _, corresponding_indices = get_best_unique_element(valid_time, time)
